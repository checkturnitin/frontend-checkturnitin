...
export default function Component() {
  ...
  const [userPlanType, setUserPlanType] = useState<string | null>(null); // New state for userPlanType
  ...
  useEffect(() => {
    ...
    setUserPlanType(searchParams.get("userPlanType")); // Extract userPlanType
      ...
      <div className="relative max-w-md w-full">
        ...
        >
          ...
          <div className="space-y-4 mt-4">
            ...
            {/* Displaying User Plan Type */}
            <div className="flex justify-between">
              <span className="text-gray-500">User Plan Type:</span>
              <span className="font-mono text-gray-800">{userPlanType || "N/A"}</span>
            </div>
          </div>
