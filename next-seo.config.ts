...
const defaultSEOConfig: DefaultSeoProps = {
  ...
  openGraph: {
    ...
    additionalMetaTags: [
      {
        name: "keywords",
        content: "No AI GPT, Nogpt, Noai GPT, GPT to Human Converter, GPT Humanizer, Humanize AI Text, Bypass Turnitin, Turnitin AI Detection Bypass, AI Detection Bypass, AI Humanizer Tool, AI Text to Human Text, Undetectable AI Writing, Avoid AI Detection, AI Content Humanization, Content Optimization Tools, Paraphrasing Tool to Avoid AI Detection, AI Writing Humanizer, AI Paraphrasing for Originality, AI Detection-Free Writing, Humanizing AI-Generated Content, Turnitin-Compatible AI Writing, How to Bypass Turnitin AI, Make AI Writing Sound More Human, Bypass AI Detectors, Content Authenticity Platform, AI Detection Bypass Solutions, AI Detection for Academic Writing, Copyleaks AI Detection Avoidance, NoAIGPT Platform, AI Humanizer by NoAIGPT, NoAIGPT Paraphrasing Tool, NoAIGPT Detection Bypass, AI Writing for Plagiarism Prevention, Converting AI Text to Human Writing, Best AI Detection Avoidance Tool, AI Text to Human Text Conversion, AI Plagiarism Alternatives, GPT-3 Humanizer, Turnitin Bypass Tool, Paraphrasing AI Text for Plagiarism, AI Plagiarism Checker, Alternatives to Quillbot, Write Human AI, How to Make GPT Text Look Human, Detectable AI Text Transformation, AI Detection Bypass Platform",
